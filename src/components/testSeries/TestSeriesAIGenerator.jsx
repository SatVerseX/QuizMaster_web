      ...
      try {
        ...
        const finalQuiz = {
          ...
          questions: quizData.questions.map(q => ({
            ...q,
            // FIX: Ensure this is null, not undefined, if disabled
            negativeMarking: aiPrompt.negativeMarking.enabled ? { ...aiPrompt.negativeMarking } : null,
            // FIX: Ensure image is null, not undefined
            image: q.image || null 
          }))
        };
              ...
              <div className={cardClasses}>
                ...
                <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {['easy', 'medium', 'hard'].map((level) => (
                        <button
                          ...
                          className={`capitalize py-2 px-3 text-sm rounded-lg border transition-all ${
                            aiPrompt.difficulty === level
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-center gap-2 py-3 rounded-lg font-semibold text-white shadow-md transition-all ${
                      loading 
                        ...
                        {q.options.map((opt, oIdx) => (
                          ...
                          >
                            <div className={`w-4 h-4 rounded-full border flex items-center justify-center ${
                               oIdx === q.correctAnswer ? "border-emerald-500 bg-emerald-500" : "border-zinc-400"
                            }`}>
