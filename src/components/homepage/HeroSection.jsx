...
const HeroSection = ({ isDark, currentUser, onViewAllSeries }) => {
  ...
  return (
    <div className={`relative overflow-hidden rounded-3xl transition-all duration-300 ${isDark
      ...
      <div className="relative z-10 px-6 py-12 md:py-16 text-center max-w-4xl mx-auto">
        ...
        <div className="max-w-xl mx-auto mb-10">
          <form onSubmit={handleSearchSubmit} className="relative group">
            <div className={`absolute inset-y-0 left-4 flex items-center pointer-events-none transition-colors ${isFocused ? 'text-emerald-500' : (isDark ? 'text-zinc-500' : 'text-zinc-400')
              }`}>
