   ...
   return (
      <div className={`min-h-screen flex flex-col ${mode('bg-slate-50', 'bg-slate-950')}`}>
         ...
         <div className="flex-1 max-w-5xl mx-auto w-full px-4 py-8 pb-32">
            ...
            {/* Messages */}
            {(error || success) && (
               <div className={`mb-6 p-4 rounded-xl flex items-center gap-3 border animate-in slide-in-from-top-4 ${error ? 'bg-red-50 border-red-200 text-red-700 dark:bg-red-900/20 dark:border-red-800/50 dark:text-red-400'
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                     ...
                     <textarea
                        ...
                        rows={3}
                        className={`w-full rounded-xl p-3 text-sm resize-none border focus:ring-2 focus:ring-indigo-500 outline-none transition-all ${mode('bg-slate-50 border-slate-200 text-slate-800 placeholder-slate-400',
                        ...
                        <div className="flex items-center justify-between">
                           ...
                           <div className="relative w-24">
                              <input
                                 ...
                                 className={`w-full px-3 py-1.5 rounded-lg border text-right font-bold outline-none focus:ring-2 focus:ring-emerald-500 ${mode('bg-white border-slate-300 text-slate-900', 'bg-zinc-900 border-zinc-600 text-white')
                                    }`}
                              />
                           </div>
                        </div>
            ...
            <div className="mt-8 flex justify-center">
               <button
                  ...
                  className={`group flex flex-col items-center gap-2 p-6 rounded-2xl border-2 border-dashed transition-all hover:scale-[1.01] active:scale-[0.99] w-full sm:w-auto min-w-[200px] ${mode('border-slate-300 hover:border-indigo-400 hover:bg-indigo-50/30',
