  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-full">
          <div className="flex justify-between items-center h-full gap-4">
            ...
            <div className="flex items-center flex-shrink-0">
              ...
              >
                <span
                  className={`text-2xl font-bold bg-gradient-to-r from-orange-500 via-red-500 to-yellow-500 bg-clip-text text-transparent transition-all duration-300 ${
            ...
            <div className="hidden md:flex flex-1 items-center justify-center">
              {currentUser && (
                <nav className={`flex items-center gap-1 px-2 py-1.5 rounded-full border shadow-sm ${
                  theme === "dark" 
            ...
            <div className="flex items-center gap-3">
              ...
              {isAdmin && (
                <Link
                  to="/create-series"
                  className={`hidden sm:flex items-center justify-center p-2 rounded-full transition-all duration-300 active:scale-95 ${
                    theme === "dark"
              ...
              >
                {currentUser ? (
                  <>
                    <button
                      className={`user-menu-trigger flex items-center gap-2   rounded-full border transition-all duration-200 ${
                        theme === "dark"
                    ...
                    `}>
                      ...
                      <div className="p-1.5 space-y-0.5">
                        <Link to="/profile" className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors ${
                          theme === "dark" ? "text-gray-300 hover:bg-gray-800" : "text-slate-600 hover:bg-slate-50"
                        }`}>
                          <Settings className="w-4 h-4" /> Settings
                        </Link>
                        <Link to="/subscriptions" className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm transition-colors ${
                          theme === "dark" ? "text-gray-300 hover:bg-gray-800" : "text-slate-600 hover:bg-slate-50"
                        }`}>
                          <CreditCard className="w-4 h-4" /> Subscription
                        </Link>
                        <div className={`h-px mx-2 my-1 ${theme === 'dark' ? 'bg-gray-800' : 'bg-slate-100'}`}></div>
                        <button onClick={handleLogout} className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
      ...
      >
        ...
        {/* Sidebar Panel */}
        <div 
          className={`absolute right-0 top-0 bottom-0 w-[80%] max-w-[300px] shadow-2xl transform transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${
              ...
              <div className="space-y-1">
                 {currentUser ? (
                   <>
                     ...
                     <MobileNavLink to="/subscriptions" icon={CreditCard} label="Subscription" />
                   </>
                 ) : (
